...
class launch {
    constructor(option) {
        ...
        if (mrule.osname == "osx") {
            this.defaultJavaParameter.push(...[
                "-Xdock:name=Minecraft"
                //"-Xdock:icon=/Users/ksi/Library/Application Support/minecraft/assets/objects/99/991b421dfd401f115241601b2b373140a8d78572"
            ]);
        }
